...
Given I assign "This sentence goes on" to variable "sentence"
...
Given I execute scenario "Calculating Exponent"
Given I "Execute Exponential logic"
...
And I assign variable $sentence by combining "and on"
And I increase variable "counter" by 1
EndWhile
EndIf
And I echo $result
And I echo "base raised by exponent is equal to result"

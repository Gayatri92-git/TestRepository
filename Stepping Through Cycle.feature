...
# Date: 05-JULY-2021
# Description: To calculate the number of steps, stories, floors and the size of the home, office, hotel
############################################################ 
Feature: Stepping Through Cycle
Background:
Given I assign 12 to variable "flight"
Given I assign 3 to variable "stories"
Given I assign 36 to variable "building_steps"
Given I assign 3 to variable "floors"
Given I assign 12 to variable "steps"
Given I assign $stories to variable "total_steps"
And I assign 1 to variable "home_size"
And I assign 4 to variable "office_size"
And I assign 12 to variable "hotel_size"

Given I import scenarios from "Utilities\Stepping Through Cycle Utilities.feature"
...
############################################################
When I multiply variable "home_size" by 12
Then I execute scenario "Calulating Number of Stairs"
